package com.baboaisystem.bitcoinkit
...
import com.baboaisystem.bitcoincore.blocks.validators.*
import com.baboaisystem.bitcoincore.core.Bip
import com.baboaisystem.bitcoincore.core.IInitialSyncApi
...
class BitcoinKit : AbstractKit {
    ...
    constructor(
        ...
        network = when (networkType) {
            ...
            NetworkType.TestNet -> {
                initialSyncApi = BCoinApi("https://btc-testnet.baboaisystem.com/api")
                TestNet()
            }
            NetworkType.RegTest -> {
